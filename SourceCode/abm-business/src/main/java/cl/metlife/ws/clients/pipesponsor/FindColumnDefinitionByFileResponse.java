...
public class FindColumnDefinitionByFileResponse {
    ...
    @XmlElementRef(name = "FindColumnDefinitionByFileResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfColumnDefinitionDTO> findColumnDefinitionByFileResult;

    /**
     * Obtiene el valor de la propiedad findColumnDefinitionByFileResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad findColumnDefinitionByFileResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfColumnDefinitionDTO }{@code >}
    ...
    public void setFindColumnDefinitionByFileResult(JAXBElement<ArrayOfColumnDefinitionDTO> value) {
        this.findColumnDefinitionByFileResult = value;
    }
