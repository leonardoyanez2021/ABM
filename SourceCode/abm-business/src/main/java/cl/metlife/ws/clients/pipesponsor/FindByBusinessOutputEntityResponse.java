...
public class FindByBusinessOutputEntityResponse {
    ...
    @XmlElementRef(name = "FindByBusinessOutputEntityResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfBusinessObjectMappingDTO> findByBusinessOutputEntityResult;

    /**
     * Obtiene el valor de la propiedad findByBusinessOutputEntityResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad findByBusinessOutputEntityResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfBusinessObjectMappingDTO }{@code >}
    ...
    public void setFindByBusinessOutputEntityResult(JAXBElement<ArrayOfBusinessObjectMappingDTO> value) {
        this.findByBusinessOutputEntityResult = value;
    }
