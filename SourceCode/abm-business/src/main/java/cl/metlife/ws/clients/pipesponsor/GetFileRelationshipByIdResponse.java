...
public class GetFileRelationshipByIdResponse {
    ...
    @XmlElementRef(name = "GetFileRelationshipByIdResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<FileRelationshipDTO> getFileRelationshipByIdResult;

    /**
     * Obtiene el valor de la propiedad getFileRelationshipByIdResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad getFileRelationshipByIdResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link FileRelationshipDTO }{@code >}
    ...
    public void setGetFileRelationshipByIdResult(JAXBElement<FileRelationshipDTO> value) {
        this.getFileRelationshipByIdResult = value;
    }
