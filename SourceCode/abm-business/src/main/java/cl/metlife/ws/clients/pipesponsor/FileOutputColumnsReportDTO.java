...
/**
 * <p>Clase Java para FileOutputColumnsReportDTO complex type.
 * 
    ...
    extends Dto
{
    ...
    @XmlElementRef(name = "ColumnType", namespace = "http://schemas.datacontract.org/2004/07/SmartGear.MetLife.Srp.Application.MainBoundedContext.DTO", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "TableColumnName", namespace = "http://schemas.datacontract.org/2004/07/SmartGear.MetLife.Srp.Application.MainBoundedContext.DTO", type = JAXBElement.class, required = false)
    protected JAXBElement<String> tableColumnName;
    @XmlElementRef(name = "TableColumnType", namespace = "http://schemas.datacontract.org/2004/07/SmartGear.MetLife.Srp.Application.MainBoundedContext.DTO", type = JAXBElement.class, required = false)
    protected JAXBElement<String> tableColumnType;
    @XmlElementRef(name = "TableName", namespace = "http://schemas.datacontract.org/2004/07/SmartGear.MetLife.Srp.Application.MainBoundedContext.DTO", type = JAXBElement.class, required = false)
    ...
    /**
     * Obtiene el valor de la propiedad tableColumnName.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
    ...
    /**
     * Define el valor de la propiedad tableColumnName.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
    ...
    /**
     * Obtiene el valor de la propiedad tableColumnType.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
    ...
    /**
     * Define el valor de la propiedad tableColumnType.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
