...
public class AddNewBuinessObjectResponse {
    ...
    @XmlElementRef(name = "AddNewBuinessObjectResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<BusinessObjectDTO> addNewBuinessObjectResult;

    /**
     * Obtiene el valor de la propiedad addNewBuinessObjectResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad addNewBuinessObjectResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link BusinessObjectDTO }{@code >}
    ...
    public void setAddNewBuinessObjectResult(JAXBElement<BusinessObjectDTO> value) {
        this.addNewBuinessObjectResult = value;
    }
