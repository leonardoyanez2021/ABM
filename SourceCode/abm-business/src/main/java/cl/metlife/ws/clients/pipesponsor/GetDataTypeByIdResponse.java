...
public class GetDataTypeByIdResponse {
    ...
    @XmlElementRef(name = "GetDataTypeByIdResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ColumnDataTypeDTO> getDataTypeByIdResult;

    /**
     * Obtiene el valor de la propiedad getDataTypeByIdResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad getDataTypeByIdResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ColumnDataTypeDTO }{@code >}
    ...
    public void setGetDataTypeByIdResult(JAXBElement<ColumnDataTypeDTO> value) {
        this.getDataTypeByIdResult = value;
    }
