...
public class AddNewColumnMappingListResponse {
    ...
    @XmlElementRef(name = "AddNewColumnMappingListResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfColumnMappingDTO> addNewColumnMappingListResult;

    /**
     * Obtiene el valor de la propiedad addNewColumnMappingListResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad addNewColumnMappingListResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfColumnMappingDTO }{@code >}
    ...
    public void setAddNewColumnMappingListResult(JAXBElement<ArrayOfColumnMappingDTO> value) {
        this.addNewColumnMappingListResult = value;
    }
