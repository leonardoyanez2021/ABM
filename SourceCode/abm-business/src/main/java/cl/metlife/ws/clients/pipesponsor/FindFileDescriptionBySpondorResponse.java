...
public class FindFileDescriptionBySpondorResponse {
    ...
    @XmlElementRef(name = "FindFileDescriptionBySpondorResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfFileDescriptionDTO> findFileDescriptionBySpondorResult;

    /**
     * Obtiene el valor de la propiedad findFileDescriptionBySpondorResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad findFileDescriptionBySpondorResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfFileDescriptionDTO }{@code >}
    ...
    public void setFindFileDescriptionBySpondorResult(JAXBElement<ArrayOfFileDescriptionDTO> value) {
        this.findFileDescriptionBySpondorResult = value;
    }
