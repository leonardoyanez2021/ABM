...
public class GetFileBusinessObjectReportBySponsorResponse {
    ...
    @XmlElementRef(name = "GetFileBusinessObjectReportBySponsorResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfFileBusinessObjectReportDTO> getFileBusinessObjectReportBySponsorResult;

    /**
     * Obtiene el valor de la propiedad getFileBusinessObjectReportBySponsorResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad getFileBusinessObjectReportBySponsorResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfFileBusinessObjectReportDTO }{@code >}
    ...
    public void setGetFileBusinessObjectReportBySponsorResult(JAXBElement<ArrayOfFileBusinessObjectReportDTO> value) {
        this.getFileBusinessObjectReportBySponsorResult = value;
    }
