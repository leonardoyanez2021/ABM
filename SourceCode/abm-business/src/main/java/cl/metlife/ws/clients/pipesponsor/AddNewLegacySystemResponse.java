...
public class AddNewLegacySystemResponse {
    ...
    @XmlElementRef(name = "AddNewLegacySystemResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<LegacySystemDTO> addNewLegacySystemResult;

    /**
     * Obtiene el valor de la propiedad addNewLegacySystemResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad addNewLegacySystemResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link LegacySystemDTO }{@code >}
    ...
    public void setAddNewLegacySystemResult(JAXBElement<LegacySystemDTO> value) {
        this.addNewLegacySystemResult = value;
    }
