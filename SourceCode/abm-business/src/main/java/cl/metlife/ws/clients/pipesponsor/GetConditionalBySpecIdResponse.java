...
public class GetConditionalBySpecIdResponse {
    ...
    @XmlElementRef(name = "GetConditionalBySpecIdResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ConditionalSpecSummaryDTO> getConditionalBySpecIdResult;

    /**
     * Obtiene el valor de la propiedad getConditionalBySpecIdResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad getConditionalBySpecIdResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ConditionalSpecSummaryDTO }{@code >}
    ...
    public void setGetConditionalBySpecIdResult(JAXBElement<ConditionalSpecSummaryDTO> value) {
        this.getConditionalBySpecIdResult = value;
    }
