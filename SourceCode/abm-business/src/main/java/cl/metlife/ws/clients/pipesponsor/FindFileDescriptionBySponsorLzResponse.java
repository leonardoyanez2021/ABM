...
public class FindFileDescriptionBySponsorLzResponse {
    ...
    @XmlElementRef(name = "FindFileDescriptionBySponsorLzResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfFileDescriptionLzDTO> findFileDescriptionBySponsorLzResult;

    /**
     * Obtiene el valor de la propiedad findFileDescriptionBySponsorLzResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad findFileDescriptionBySponsorLzResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfFileDescriptionLzDTO }{@code >}
    ...
    public void setFindFileDescriptionBySponsorLzResult(JAXBElement<ArrayOfFileDescriptionLzDTO> value) {
        this.findFileDescriptionBySponsorLzResult = value;
    }
