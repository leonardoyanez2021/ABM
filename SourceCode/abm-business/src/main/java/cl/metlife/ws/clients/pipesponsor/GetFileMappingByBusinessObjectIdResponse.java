...
public class GetFileMappingByBusinessObjectIdResponse {
    ...
    @XmlElementRef(name = "GetFileMappingByBusinessObjectIdResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<FileMappingDTO> getFileMappingByBusinessObjectIdResult;

    /**
     * Obtiene el valor de la propiedad getFileMappingByBusinessObjectIdResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad getFileMappingByBusinessObjectIdResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link FileMappingDTO }{@code >}
    ...
    public void setGetFileMappingByBusinessObjectIdResult(JAXBElement<FileMappingDTO> value) {
        this.getFileMappingByBusinessObjectIdResult = value;
    }
