...
public class GetColumnListResponse {
    ...
    @XmlElementRef(name = "GetColumnListResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfOutputColumnDTO> getColumnListResult;

    /**
     * Obtiene el valor de la propiedad getColumnListResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad getColumnListResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfOutputColumnDTO }{@code >}
    ...
    public void setGetColumnListResult(JAXBElement<ArrayOfOutputColumnDTO> value) {
        this.getColumnListResult = value;
    }
