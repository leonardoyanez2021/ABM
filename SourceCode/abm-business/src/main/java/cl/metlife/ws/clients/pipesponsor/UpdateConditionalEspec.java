...
public class UpdateConditionalEspec {
    ...
    @XmlElementRef(name = "conditionalEspec", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ConditionalEspecDTO> conditionalEspec;

    /**
     * Obtiene el valor de la propiedad conditionalEspec.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad conditionalEspec.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ConditionalEspecDTO }{@code >}
