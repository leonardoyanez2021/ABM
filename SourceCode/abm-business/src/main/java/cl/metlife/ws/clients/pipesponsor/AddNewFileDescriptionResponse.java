...
public class AddNewFileDescriptionResponse {
    ...
    @XmlElementRef(name = "AddNewFileDescriptionResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<FileDescriptionDTO> addNewFileDescriptionResult;

    /**
     * Obtiene el valor de la propiedad addNewFileDescriptionResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad addNewFileDescriptionResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link FileDescriptionDTO }{@code >}
    ...
    public void setAddNewFileDescriptionResult(JAXBElement<FileDescriptionDTO> value) {
        this.addNewFileDescriptionResult = value;
    }
