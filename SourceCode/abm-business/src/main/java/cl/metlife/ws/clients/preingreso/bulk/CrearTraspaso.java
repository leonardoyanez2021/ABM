 ...
 *         &lt;element name="movto" type="{http://preingreso.metlife.cl/}MovtoTraspasoBo" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CrearTraspaso")
public class CrearTraspaso {

    protected String sesionId;
    protected MovtoTraspasoBo movto;
     ...
     * @return
     *     possible object is
     *     {@link MovtoTraspasoBo }
     *     
     */
    public MovtoTraspasoBo getMovto() {
        return movto;
    }
     ...
     *     
     */
    public void setMovto(MovtoTraspasoBo value) {
        this.movto = value;
    }
