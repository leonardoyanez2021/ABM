...
public class GetConditionalEspecByIdResponse {
    ...
    @XmlElementRef(name = "GetConditionalEspecByIdResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ConditionalEspecDTO> getConditionalEspecByIdResult;

    /**
     * Obtiene el valor de la propiedad getConditionalEspecByIdResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad getConditionalEspecByIdResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ConditionalEspecDTO }{@code >}
    ...
    public void setGetConditionalEspecByIdResult(JAXBElement<ConditionalEspecDTO> value) {
        this.getConditionalEspecByIdResult = value;
    }
