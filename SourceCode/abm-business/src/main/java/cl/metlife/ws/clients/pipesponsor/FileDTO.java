 ...
 *         &lt;element name="FileInterfaces" type="{http://schemas.datacontract.org/2004/07/SmartGear.MetLife.Srp.Application.MainBoundedContext.DTO}ArrayOfFileInterfaceWhitColumnsDTO" minOccurs="0"/>
 ...
 *         &lt;element name="InterfacesDefined" type="{http://www.w3.org/2001/XMLSchema}unsignedByte" minOccurs="0"/>
    ...
    extends Dto
{
    ...
    @XmlElementRef(name = "ColumnDefinitions", namespace = "http://schemas.datacontract.org/2004/07/SmartGear.MetLife.Srp.Application.MainBoundedContext.DTO", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "FileInterfaces", namespace = "http://schemas.datacontract.org/2004/07/SmartGear.MetLife.Srp.Application.MainBoundedContext.DTO", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfFileInterfaceWhitColumnsDTO> fileInterfaces;
    ...
    @XmlElement(name = "InterfacesDefined")
    @XmlSchemaType(name = "unsignedByte")
    protected Short interfacesDefined;
    ...
    /**
     * Obtiene el valor de la propiedad columnDefinitions.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad columnDefinitions.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfColumnDefinitionLzDTO }{@code >}
    ...
    /**
     * Obtiene el valor de la propiedad fileInterfaces.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfFileInterfaceWhitColumnsDTO }{@code >}
     *     
     */
    public JAXBElement<ArrayOfFileInterfaceWhitColumnsDTO> getFileInterfaces() {
        return fileInterfaces;
    }

    /**
     * Define el valor de la propiedad fileInterfaces.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfFileInterfaceWhitColumnsDTO }{@code >}
     *     
     */
    public void setFileInterfaces(JAXBElement<ArrayOfFileInterfaceWhitColumnsDTO> value) {
        this.fileInterfaces = value;
    }
    ...
    /**
     * Obtiene el valor de la propiedad interfacesDefined.
     * 
     * @return
     *     possible object is
     *     {@link Short }
     *     
     */
    public Short getInterfacesDefined() {
        return interfacesDefined;
    }

    /**
     * Define el valor de la propiedad interfacesDefined.
     * 
     * @param value
     *     allowed object is
     *     {@link Short }
     *     
     */
    public void setInterfacesDefined(Short value) {
        this.interfacesDefined = value;
    }
