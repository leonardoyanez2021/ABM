...
public class UpdateDataMapping {
    ...
    @XmlElementRef(name = "dataMapping", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<DataMappingDTO> dataMapping;

    /**
     * Obtiene el valor de la propiedad dataMapping.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad dataMapping.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link DataMappingDTO }{@code >}
