...
public class GetAllBusinessObjectsResponse {
    ...
    @XmlElementRef(name = "GetAllBusinessObjectsResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfBusinessObjectDTO> getAllBusinessObjectsResult;

    /**
     * Obtiene el valor de la propiedad getAllBusinessObjectsResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad getAllBusinessObjectsResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfBusinessObjectDTO }{@code >}
    ...
    public void setGetAllBusinessObjectsResult(JAXBElement<ArrayOfBusinessObjectDTO> value) {
        this.getAllBusinessObjectsResult = value;
    }
