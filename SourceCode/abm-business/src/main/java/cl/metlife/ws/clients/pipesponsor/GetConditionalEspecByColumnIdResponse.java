...
public class GetConditionalEspecByColumnIdResponse {
    ...
    @XmlElementRef(name = "GetConditionalEspecByColumnIdResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfConditionalEspecDTO> getConditionalEspecByColumnIdResult;

    /**
     * Obtiene el valor de la propiedad getConditionalEspecByColumnIdResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad getConditionalEspecByColumnIdResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfConditionalEspecDTO }{@code >}
    ...
    public void setGetConditionalEspecByColumnIdResult(JAXBElement<ArrayOfConditionalEspecDTO> value) {
        this.getConditionalEspecByColumnIdResult = value;
    }
