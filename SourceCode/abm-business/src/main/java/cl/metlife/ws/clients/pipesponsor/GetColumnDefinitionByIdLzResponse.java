...
public class GetColumnDefinitionByIdLzResponse {
    ...
    @XmlElementRef(name = "GetColumnDefinitionByIdLzResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ColumnDefinitionLzDTO> getColumnDefinitionByIdLzResult;

    /**
     * Obtiene el valor de la propiedad getColumnDefinitionByIdLzResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad getColumnDefinitionByIdLzResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ColumnDefinitionLzDTO }{@code >}
    ...
    public void setGetColumnDefinitionByIdLzResult(JAXBElement<ColumnDefinitionLzDTO> value) {
        this.getColumnDefinitionByIdLzResult = value;
    }
