...
public class FindBusinessObjectFieldByColumnDefinitionResponse {
    ...
    @XmlElementRef(name = "FindBusinessObjectFieldByColumnDefinitionResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfBusinessObjectFieldDTO> findBusinessObjectFieldByColumnDefinitionResult;

    /**
     * Obtiene el valor de la propiedad findBusinessObjectFieldByColumnDefinitionResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad findBusinessObjectFieldByColumnDefinitionResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfBusinessObjectFieldDTO }{@code >}
    ...
    public void setFindBusinessObjectFieldByColumnDefinitionResult(JAXBElement<ArrayOfBusinessObjectFieldDTO> value) {
        this.findBusinessObjectFieldByColumnDefinitionResult = value;
    }
