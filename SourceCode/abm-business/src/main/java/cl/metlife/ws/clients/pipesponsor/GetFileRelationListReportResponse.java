...
public class GetFileRelationListReportResponse {
    ...
    @XmlElementRef(name = "GetFileRelationListReportResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfFileRelationsReportDTO> getFileRelationListReportResult;

    /**
     * Obtiene el valor de la propiedad getFileRelationListReportResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad getFileRelationListReportResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfFileRelationsReportDTO }{@code >}
    ...
    public void setGetFileRelationListReportResult(JAXBElement<ArrayOfFileRelationsReportDTO> value) {
        this.getFileRelationListReportResult = value;
    }
