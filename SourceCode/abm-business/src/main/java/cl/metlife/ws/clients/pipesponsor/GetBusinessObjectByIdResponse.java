...
public class GetBusinessObjectByIdResponse {
    ...
    @XmlElementRef(name = "GetBusinessObjectByIdResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<BusinessObjectDTO> getBusinessObjectByIdResult;

    /**
     * Obtiene el valor de la propiedad getBusinessObjectByIdResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad getBusinessObjectByIdResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link BusinessObjectDTO }{@code >}
    ...
    public void setGetBusinessObjectByIdResult(JAXBElement<BusinessObjectDTO> value) {
        this.getBusinessObjectByIdResult = value;
    }
