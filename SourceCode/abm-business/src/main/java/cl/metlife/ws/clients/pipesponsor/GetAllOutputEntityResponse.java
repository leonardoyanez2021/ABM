...
public class GetAllOutputEntityResponse {
    ...
    @XmlElementRef(name = "GetAllOutputEntityResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfOutputEntityDTO> getAllOutputEntityResult;

    /**
     * Obtiene el valor de la propiedad getAllOutputEntityResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad getAllOutputEntityResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfOutputEntityDTO }{@code >}
    ...
    public void setGetAllOutputEntityResult(JAXBElement<ArrayOfOutputEntityDTO> value) {
        this.getAllOutputEntityResult = value;
    }
