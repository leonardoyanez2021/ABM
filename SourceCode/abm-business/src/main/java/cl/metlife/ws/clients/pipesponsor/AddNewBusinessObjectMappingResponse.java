...
public class AddNewBusinessObjectMappingResponse {
    ...
    @XmlElementRef(name = "AddNewBusinessObjectMappingResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<BusinessObjectMappingDTO> addNewBusinessObjectMappingResult;

    /**
     * Obtiene el valor de la propiedad addNewBusinessObjectMappingResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad addNewBusinessObjectMappingResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link BusinessObjectMappingDTO }{@code >}
    ...
    public void setAddNewBusinessObjectMappingResult(JAXBElement<BusinessObjectMappingDTO> value) {
        this.addNewBusinessObjectMappingResult = value;
    }
