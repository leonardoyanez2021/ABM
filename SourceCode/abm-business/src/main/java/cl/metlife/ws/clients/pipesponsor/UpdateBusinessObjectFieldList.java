...
public class UpdateBusinessObjectFieldList {
    ...
    @XmlElementRef(name = "businessObjectFieldList", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfBusinessObjectFieldLzDTO> businessObjectFieldList;

    /**
     * Obtiene el valor de la propiedad businessObjectFieldList.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad businessObjectFieldList.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfBusinessObjectFieldLzDTO }{@code >}
    ...
    public void setBusinessObjectFieldList(JAXBElement<ArrayOfBusinessObjectFieldLzDTO> value) {
        this.businessObjectFieldList = value;
    }
