...
public class FindAllOutputColumnByOutputEntityResponse {
    ...
    @XmlElementRef(name = "FindAllOutputColumnByOutputEntityResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfOutputColumnDTO> findAllOutputColumnByOutputEntityResult;

    /**
     * Obtiene el valor de la propiedad findAllOutputColumnByOutputEntityResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad findAllOutputColumnByOutputEntityResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfOutputColumnDTO }{@code >}
    ...
    public void setFindAllOutputColumnByOutputEntityResult(JAXBElement<ArrayOfOutputColumnDTO> value) {
        this.findAllOutputColumnByOutputEntityResult = value;
    }
