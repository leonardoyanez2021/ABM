...
public class AddNewOutputEntity {
    ...
    @XmlElementRef(name = "outputEntity", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<OutputEntityDTO> outputEntity;

    /**
     * Obtiene el valor de la propiedad outputEntity.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad outputEntity.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link OutputEntityDTO }{@code >}
