...
public class LogProcessTimerManager {
    ...
    public void addTimer( Process process, ScheduleExpression scheduleExpression) {
        ...
        logger.info(String.format("activando timer para proceso %s", process.getId()));
    ...
    public Timer getTimerForProcess(Process process) {
        ...
        logger.debug(String.format("buscando timer para proceso id %s",(process!=null?process.getId() : null)));
