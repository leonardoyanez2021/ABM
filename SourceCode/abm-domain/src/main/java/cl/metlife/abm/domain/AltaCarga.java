 ...
 */
@Entity
@Table(name = "ABM_TESTALTACARGA")
public class AltaCarga extends Operation implements Serializable {
    ...
    public String toString() {
        return "alta carga "+ "[policy: " + id + ", ruttit: " + rutTit + "-" + dvTit + ", nombre: " + nom + pat + mat + ", rutcarga: " + rutCar + "-" + dvCar + ", lote: " + lote + ", lotid: " + lotId + "]";
    }
